...
#define POS_CURVA_90 30	// Posi��o para habilitar a leitura da curva de 90 graus
...
private:
    ...
    int trilha_min;     // Tamanho mínimo da trilha (em pixels)
    int trilha_max;     // Tamanho máximo da trilha (em pixels)
    int varredura;      // Faixa da varredura em relação à posição do centro anterior (em pixels)
